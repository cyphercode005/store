...
export default (variables /* : * */ = variable) => {
  ...
  const headerTheme = {
    ...
    '.noLeft': {
      'NativeBase.Left': {
        width: platform === PLATFORM.IOS ? 0 : 0,
    ...
    '.searchBar': {
      ...
      'NativeBase.Button': {
        '.transparent': {
          ...
          paddingLeft: platform === PLATFORM.IOS ? null : null
        },
        paddingHorizontal: platform === PLATFORM.IOS ? null : null,
        width: platform === PLATFORM.IOS ? 0 : 0,
        height: platform === PLATFORM.IOS ? 0 : 0
      }
    },
    '.rounded': {
      'NativeBase.Item': {
    ...
    'NativeBase.Left': {
      'NativeBase.Button': {
        ...
        '.transparent': {
          ...
          'NativeBase.Text': {
            color: variables.toolbarBtnTextColor,
            fontSize: platform === PLATFORM.IOS ? 14 : 14,
            top: platform === PLATFORM.IOS ? -1.5 : -1.5,
            paddingLeft:
              platform === PLATFORM.IOS && platformStyle !== PLATFORM.MATERIAL
                ? 5
                : 5,
    ...
    'NativeBase.Body': {
      ...
      'NativeBase.Segment': {
        borderWidth: 0,
        alignSelf: 'flex-end',
        marginRight: platform === PLATFORM.IOS ? -55 : -55
      },
      'NativeBase.Button': {
        alignSelf: 'center',
        '.transparent': {
    ...
    'NativeBase.Right': {
      'NativeBase.Button': {
        ...
        '.transparent': {
          marginRight: platform === PLATFORM.IOS ? -5 : -5,
          paddingLeft: 15,
          paddingRight: 12,
          paddingHorizontal: 15,
          borderRadius: 50,
