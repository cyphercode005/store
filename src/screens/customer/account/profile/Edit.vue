    ...
    <nb-container>
        ...
        <nb-content padder>
            ...
            <InputWithError
                ...
                :msg="errors.email!='' ? errors.email : ($v.form.email.required && !$v.form.email.$email) ? 'Invalid email address' : 'Email field is required'">
                <nb-label class="input-label">Email</nb-label>
                <nb-input  class="input-field" :on-change-text="(text)=>{form.email=text}" :defaultValue="form.email" placeholder="Email"
                    :on-blur="() => $v.form.email.$touch()" />
            </InputWithError>
            <InputWithError
                :error="$v.form.phone.$dirty && (!$v.form.phone.required || $v.form.phone.$invalid || errors.phone)"
                :msg="errors.phone!='' ? errors.phone : ($v.form.phone.required && !$v.form.phone.$numeric) ? 'Mobile number entered is invalid' : 'Mobile field is required'">
                <nb-label class="input-label">Mobile</nb-label>
                <nb-input   keyboardType="phone-pad" class="input-field" :on-change-text="(text)=>{form.phone=text}" :defaultValue="form.phone" placeholder="Email"
